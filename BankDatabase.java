...
public class BankDatabase {
   ...
   public BankDatabase() {
      ...
      accounts[0] = new SavingAccount(12345, 54321, 1000.0, 1000.0);
      accounts[1] = new ChequeAccount(98765, 56789, 200.0, 200.0);
      accounts[2] = new SavingAccount(11451, 19198, 59000.0, 59000.0);
      accounts[3] = new ChequeAccount(77777, 99999, 799999.0, 799999.0);
